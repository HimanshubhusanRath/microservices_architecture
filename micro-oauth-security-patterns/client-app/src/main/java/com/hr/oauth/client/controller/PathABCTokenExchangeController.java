...
@RestController
@RequestMapping(path="/path-abc", params = "flow_type=token_exchange")
public class PathABCTokenExchangeController extends BaseController{
	...
	protected PathABCTokenExchangeController(WebClient webClient, ServicesConfiguration servicesConfig) {
	...
	{
		System.out.println(" ======================= SERVICE-C IS CALLED USING 'TOKEN-EXCHANGE' ============");
