...
public class ServiceResponse {
	...
	private List<ServiceResponse> serviceCallResponses = Collections.emptyList();
	...
	public List<ServiceResponse> getServiceCallResponses() {
		return this.serviceCallResponses;
	}

	public void setServiceCallResponses(List<ServiceResponse> serviceCallResponses) {
